...
public class java_wxdialog {
  ...
  public java_wxdialog(java_wxframe parent, int id, String title, int x, int y, int width, int height, int style, String name) {
    this(wxdialog_moduleJNI.new_java_wxdialog(java_wxframe.getCPtr(parent), parent, id, title, x, y, width, height, style, name), true);
  }
